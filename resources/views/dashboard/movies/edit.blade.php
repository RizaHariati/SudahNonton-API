...
<div class="dashboard-container">
  <div class="dashboard ">
    ...
    <div class="dashboard-title">
      <h4>Edit Movie</h4>
      <a href="/dashboard/movies/" class="btn btn-primary">Cancel</a>
    </div>
    <div class="dashboard-content-container">
      <div class="dashboard-image-container">
        <img class="small-img" src="https://www.themoviedb.org/t/p/w500{{$edit->image}}" alt="{{ $edit->title }}">
      </div>
      <div class="dashboard-info-container">
        <form action="/dashboard/movies/{{ $edit->id }}" enctype="multipart/form-data" method="POST">
          @method('put')
          @csrf
          <h4>Editing {{$edit->title }}</h4>
